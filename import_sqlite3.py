...
class Image(object):
    ...
    def load_directory(self, path='C:/Users/Marciel/Pictures'):
        """
    ...
    def create_database(self, name, image):
        ...
        (name TEXT,image BLOP,idusuario integer primary key autoincrement)""")
...
def main():
    obj = Image()
    os.chdir("C:/Users/Marciel/Pictures")
